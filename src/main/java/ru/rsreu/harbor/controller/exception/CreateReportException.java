...
public class CreateReportException extends ActionCommandException {
    @Override
    public ActionCommandResult getActionCommandResult(HttpServletRequest request) {
        request.getSession().setAttribute(
                ...
                Resourcer.getString("message.error.createReport")
        );
        return new ActionCommandResult(
                Resourcer.getString("command.path.showCreateReportPage"),

...
public class PierDaoImpl implements PierDao {
    ...
    private static final String PIER_BY_USER_SQL = Resourcer.getString("dao.pier.user.sql");
    ...
    @Override
    public Optional<Pier> findByUser(User captain) {
        return OptionalCreator.createOptionalObjectFromList(
                this.jdbcQueryExecutor.executeQuery(this.pierRowMapper, PIER_BY_USER_SQL, captain.getId().toString()));
    }
